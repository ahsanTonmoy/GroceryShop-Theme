        ...
        <div>
            ...
            <div className="my-8">
                ...
                <div className="grid md:grid-cols-2 h-2/3 gap-4">
                    {
                        offers.map(item => <div key={item.id} className="item lg:flex gap-4 border w-full lg:h-[240px] p-4 rounded">
                            ...
                            <div className="lg:w-1/3 py-4 text-center grid gap-2">
                                ...
                                <button className="py-2 flex px-4 gap-1 border rounded capitalize font-bold text-[#ff686e] w-12/12 mx-auto">
